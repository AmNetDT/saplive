<?php 
 ...
 set_time_limit(0);   
  ...
  $xlsFile = $rpt_section."_$report_title"."_$start_dtt.xls";
   ...
   $start_row = 5;
   $col = 1;
   $headers = array('SN','Channel','Region','Customer Code','Customer Name','Address','Phone No.','Rep Name','Depot','Rep Visit','Used Last TLP','Selling Competition','How do u rate our Service','How do we serve you better','Time','Agent');   
